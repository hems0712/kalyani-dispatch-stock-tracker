...
const KalyaniLogo = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <radialGradient id="kalyaniGradLogin" cx="50%" cy="50%" r="50%" fx="75%" fy="25%">
        <stop offset="0%" stopColor="#3b82f6" />
        <stop offset="100%" stopColor="#1e3a8a" />
      </radialGradient>
      <clipPath id="logoClipLogin">
        <circle cx="50" cy="50" r="48" />
      </clipPath>
    </defs>
    <circle cx="50" cy="50" r="48" fill="url(#kalyaniGradLogin)" />
    <g clipPath="url(#logoClipLogin)">
      <path 
    ...
    <div className="min-h-screen bg-[#030712] flex items-center justify-center p-4">
      <div className="w-full max-w-[400px] space-y-6">
        <div className="text-center space-y-2">
          <div className="inline-flex items-center justify-center p-4 bg-white/5 rounded-3xl mb-4 border border-white/10 shadow-2xl w-32 h-32 backdrop-blur-sm">
            <KalyaniLogo className="w-full h-full" />
          </div>
          <div className="space-y-1">
            <h1 className="font-headline text-4xl font-black tracking-[0.2em] text-white uppercase leading-none">
              Kalyani
            </h1>
